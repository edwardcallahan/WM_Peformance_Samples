Main.widgets = {
	lvarCity: ["wm.LiveVariable", {"autoUpdate":false,"liveSource":"com.worlddb.data.City","maxResults":5000}, {}],
	filmDialog: ["wm.DesignableDialog", {"height":392,"title":"film","width":"500px","containerWidgetId":"containerWidget","buttonBarId":"buttonBar"}, {}, {
		containerWidget: ["wm.Container", {"_classes":{"domNode":["wmdialogcontainer","MainContent"]},"autoScroll":true,"height":"100%","horizontalAlign":"left","margin":"0","padding":"5","verticalAlign":"top","width":"100%"}, {}, {
			filmLiveForm1: ["wm.LiveForm", {"alwaysPopulateEditors":true,"fitToContentHeight":true,"height":"318px","horizontalAlign":"left","liveEditing":false,"margin":"4","verticalAlign":"top"}, {"onSuccess":"filmLivePanel1.popupLiveFormSuccess"}, {
				...
				titleEditor1: ["wm.Text", {"caption":"Title","captionSize":"200px","dataValue":"ACADEMY DINOSAUR","emptyValue":"emptyString","formField":"title","height":"26px","required":true,"width":"100%"}, {}],
				descriptionEditor1: ["wm.Text", {"caption":"Description","captionSize":"200px","dataValue":"A Epic Drama of a Feminist And a Mad Scientist who must Battle a Teacher in The Canadian Rockies","emptyValue":"emptyString","formField":"description","height":"26px","width":"100%"}, {}],
				releaseYearEditor1: ["wm.DateTime", {"caption":"ReleaseYear","captionSize":"200px","dataValue":1136102400000,"dateMode":"Date","emptyValue":"emptyString","formField":"releaseYear","height":"26px","width":"100%"}, {}],
				...
				ratingEditor1: ["wm.Text", {"caption":"Rating","captionSize":"200px","dataValue":"PG","emptyValue":"emptyString","formField":"rating","height":"26px","width":"100%"}, {}],
				specialFeaturesEditor1: ["wm.Text", {"caption":"SpecialFeatures","captionSize":"200px","dataValue":"Deleted Scenes,Behind the Scenes","emptyValue":"emptyString","formField":"specialFeatures","height":"26px","width":"100%"}, {}],
				lastUpdateEditor1: ["wm.DateTime", {"caption":"LastUpdate","captionSize":"200px","dataValue":1139904000000,"dateMode":"Date","emptyValue":"emptyString","formField":"lastUpdate","height":"26px","required":true,"width":"100%"}, {}],
	...
	staffDialog: ["wm.DesignableDialog", {"height":364,"title":"staff","width":"500px","containerWidgetId":"containerWidget1","buttonBarId":"buttonBar"}, {}, {
		containerWidget1: ["wm.Container", {"_classes":{"domNode":["wmdialogcontainer","MainContent"]},"autoScroll":true,"height":"100%","horizontalAlign":"left","margin":"0","padding":"5","verticalAlign":"top","width":"100%"}, {}, {
			staffLiveForm1: ["wm.LiveForm", {"alwaysPopulateEditors":true,"fitToContentHeight":true,"height":"290px","horizontalAlign":"left","liveEditing":false,"margin":"4","verticalAlign":"top"}, {"onSuccess":"staffLivePanel1.popupLiveFormSuccess"}, {
				...
				firstNameEditor1: ["wm.Text", {"border":"0","caption":"FirstName","captionSize":"200px","dataValue":"","emptyValue":"emptyString","formField":"firstName","height":"26px","required":true,"width":"100%"}, {}],
	...
	staffLiveVariable1: ["wm.LiveVariable", {"liveSource":"app.staffLiveView1"}, {}],
		...
		panel3: ["wm.Panel", {"height":"100%","horizontalAlign":"left","minHeight":600,"minWidth":900,"verticalAlign":"top","width":"75%"}, {}, {
			panel1: ["wm.HeaderContentPanel", {"border":"0,0,1,0","borderColor":"#333333","height":"65px","horizontalAlign":"left","layoutKind":"left-to-right","padding":"0,10","verticalAlign":"middle","width":"100%"}, {}, {
				...
				panel5: ["wm.Panel", {"height":"100%","horizontalAlign":"right","verticalAlign":"middle","width":"100%"}, {}, {
					selectMenu1: ["wm.SelectMenu", {"caption":"Find a Store:","displayField":"district","displayValue":"","hasDownArrow":false,"placeHolder":"Enter City Name"}, {}, {
						binding: ["wm.Binding", {}, {}, {
				...
				tabLayers1: ["wm.TabLayers", {}, {}, {
					...
					layer2: ["wm.Layer", {"border":"1","borderColor":"#999999","caption":"Film Details","horizontalAlign":"left","margin":"2,0,2,0","verticalAlign":"top"}, {}, {
						...
						liveForm1: ["wm.LiveForm", {"fitToContentHeight":true,"height":"310px","horizontalAlign":"left","readonly":true,"verticalAlign":"top"}, {}, {
							...
							titleEditor2: ["wm.Text", {"caption":"Title","captionSize":"200px","dataValue":"ACADEMY DINOSAUR","emptyValue":"emptyString","formField":"title","height":"26px","readonly":true,"required":true,"width":"100%"}, {}],
							descriptionEditor2: ["wm.Text", {"caption":"Description","captionSize":"200px","dataValue":"A Epic Drama of a Feminist And a Mad Scientist who must Battle a Teacher in The Canadian Rockies","emptyValue":"emptyString","formField":"description","height":"26px","readonly":true,"width":"100%"}, {}],
							releaseYearEditor2: ["wm.DateTime", {"caption":"ReleaseYear","captionSize":"200px","dataValue":1136102400000,"dateMode":"Date","emptyValue":"emptyString","formField":"releaseYear","height":"26px","readonly":true,"width":"100%"}, {}],
							...
							ratingEditor2: ["wm.Text", {"caption":"Rating","captionSize":"200px","dataValue":"PG","emptyValue":"emptyString","formField":"rating","height":"26px","readonly":true,"width":"100%"}, {}],
							specialFeaturesEditor2: ["wm.Text", {"caption":"SpecialFeatures","captionSize":"200px","dataValue":"Deleted Scenes,Behind the Scenes","emptyValue":"emptyString","formField":"specialFeatures","height":"26px","readonly":true,"width":"100%"}, {}],
							lastUpdateEditor2: ["wm.DateTime", {"caption":"LastUpdate","captionSize":"200px","dataValue":1139904000000,"dateMode":"Date","emptyValue":"emptyString","formField":"lastUpdate","height":"26px","readonly":true,"required":true,"width":"100%"}, {}],
					...
					layer3: ["wm.Layer", {"border":"1","borderColor":"#999999","caption":"Meet the Team","horizontalAlign":"left","margin":"2,0,2,0","verticalAlign":"top"}, {}, {
